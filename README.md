...
**NOTE:** An iOS development build requires a paid Apple Developer account. 

`eas build --profile development --platform ios`

For more information in development builds, see Expo build docs for [Internal Distribution](https://docs.expo.dev/build/internal-distribution/).
